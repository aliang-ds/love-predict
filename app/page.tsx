      ...
      <div className="relative h-full flex items-center justify-center">
        <div className="w-full max-w-2xl mx-auto px-4 flex flex-col items-center">
          ...
          <div className="w-full flex flex-col items-center">
            ...
            <div className="w-full space-y-6 mb-12 flex flex-col items-center">
              <p className="text-2xl text-gray-600 hover:text-pink-500 transition-colors text-center">
                💘 想知道你们的缘分有多深吗？
              </p>
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6 mb-12 max-w-lg">
              <div className="p-6 bg-white/90 rounded-lg shadow-md hover:shadow-xl transition-shadow text-center">
